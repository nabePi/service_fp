<?php
    class FingerPLib {
        ...
        public function __construct($ip, $port) {
            ...
            include_once("lib/zkconst.php");
            include_once("lib/zkconnect.php");
            include_once("lib/zkdevice.php");
            include_once("lib/zkuser.php");
            include_once("lib/zkattendance.php");
			      include_once("lib/zktime.php");
        }
